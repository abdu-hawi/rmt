    ...
    <form method="POST" action="{{ route('admin.products.store') }}" class="glass-card p-6 max-w-2xl space-y-5">
        ...
        <div class="grid grid-cols-2 gap-5">
            <div>
                ...
                <input type="number" step="0.01" min="0" name="price_usd" id="price_usd" value="{{ old('price_usd') }}" required
            ...
            <div>
                ...
                <input type="number" step="0.01" min="0" name="price_sar" id="price_sar" value="{{ old('price_sar') }}" required
                       data-rate="{{ config('currency.rate_usd_to_sar', 3.75) }}" class="input-floating">
            </div>
        </div>
